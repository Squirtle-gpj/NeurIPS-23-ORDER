...
if __name__ == '__main__':
    ...
    parser.add_argument("--n_code", default=40, help="", type=int)
    parser.add_argument("--code_dim", default=3, help="", type=int)
    ...
    config = Config(args)
    config.load_config("vq_vae_v2", config.cfg_filename, format="yaml")
